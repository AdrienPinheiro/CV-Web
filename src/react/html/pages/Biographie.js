        ...
        <div className="biographie">
            <div className="profil">
                ...
                <div className="column">
                    ...
                    j'ai exploré plusieurs secteurs avant de me retourner vers une passion qui ne m'avait pas directement sauté aux yeux, l'informatique. <br/> 
                    ...
                    J'avais envie de découvrir de nouvelles plateformes et après m'être renseigné sur le sujet, 
            ...
            <div className="objectif">
                <div className="top-card-biographie">
                    ...
                    Côté professionnel, je vais apprendre à aller plus loin en essayant d'y intégrer une carte interactive avec des sons lors de passages 
                    sur les menus ou m'améliorer sur le Front ! Tant que je m'améliore, cela ne peut être qu'une bonne idée. <br/> 
