        ...
        <div className="project">
            ...
            <div className="project-footer">
                ...
                <div className="project-footer-github">
                    <a href="https://github.com/AdrienPinheiro/AdrienPinheiro.Reservia" target="_blank"><i class="fab fa-github-square"/></a>
                    <h5>Code Github</h5>
                </div>
                <div className="project-footer-page">
                    <a href="https://adrienpinheiro.github.io/AdrienPinheiro.Reservia/" target="_blank"><i class="fas fa-pager"></i></a>
                    <h5>Page Internet</h5>
                </div>
            </div>
        </div>
